...
static const char *const yytname[] =
{
  ...
  "LLAVEIZQ", "LLAVEDER", "PUNTOYCOMA", "$accept", "programa", "$@1",
  "instrucciones", "instruccion", "bloque", "$@2", YY_NULLPTR
};
...
{
      13,     4,     5,     6,    16,     4,     5,     6,    13,     3,
      10,    11,    14,    15
};

static const yytype_int8 yycheck[] =
{
       7,     3,     4,     5,     6,     3,     4,     5,    15,     0,
       7,     3,     7,    12
};
...
#line 1104 "parser.tab.c"
  ...
  case 6: /* instruccion: INT ID PUNTOYCOMA  */
#line 55 "parser.y"
                                { agregar_local((yyvsp[-1].str)); }
#line 1110 "parser.tab.c"
    break;

  case 7: /* instruccion: ID PUNTOYCOMA  */
#line 56 "parser.y"
                                {
...
#line 1125 "parser.tab.c"
  ...
  case 10: /* bloque: LLAVEIZQ $@2 instrucciones LLAVEDER  */
#line 66 "parser.y"
             { salir_ambito(); }
